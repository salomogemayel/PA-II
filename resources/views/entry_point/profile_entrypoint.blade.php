    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card shadow">
                <div class="card-header bg-primary text-white" style="font-size: 20px">{{ __('Entry Point Profile') }}</div>
                ...
                <div class="card-body text-center">
                    ...
                    <div style="display: flex;">
                        ...
                        <div class="mb-6 d-flex align-items-center m-5">
                            <div style="color: #333; font-weight: bold; margin-bottom: 5px; font-size: 18px;">{{ $Entry->username }}</div>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="name" type="text" class="form-control-plaintext text-center" style="color: #333; font-weight: bold; font-size: 16px;" name="name" value="{{ $Entry->nama }}" readonly>
                        </div>
                        <label for="username" class="col-md-4 col-form-label text-md-right">{{ __('Username') }}</label>
                        <div class="col-md-6">
                            <input id="username" type="text" class="form-control-plaintext text-center" style="color: #333; font-weight: bold; font-size: 16px;" name="username" value="{{ $Entry->username }}" readonly>
                        </div>
