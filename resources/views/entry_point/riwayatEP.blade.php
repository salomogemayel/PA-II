            ...
            <div class="table-responsive">
                <div class="row mb-3">
                    <div class="d-flex align-items-end justify-content-end">
                        ...
                        <a href="{{ route('riwayat.cetak') }}" class="btn btn-primary btn-custom me-2">
                            <i class="fas fa-print"></i> Cetak
                        </a>
                        <input type="date" id="tanggalFilter" class="form-control input-custom" style="margin: 0;">
                    </div> 
                    <div class="col-md-3">
                ...
                <table class="table table-responsive-md">
                    ...
                    <tbody id="riwayatTableBody">
                        ...
                        <tr class="custom-span riwayat-row">
                            ...
                            <td>
                                <!-- Tombol detail -->
                                <a href="#" data-bs-toggle="modal" data-bs-target="#undanganDetailModal{{ $item->id }}" class="btn btn-primary btn-sm btn-detail">
                                    Detail
                                </a>   
                            </td>
                        </tr>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-body">
                ...
                <div>
                    <p><strong>Nama:</strong> {{ $item->pengunjung->namaLengkap }}</p>
                    <p><strong>Host:</strong> {{ $item->host->nama }}</p>
                    <p><strong>Kunjungan dari:</strong> {{ $item->kunjungan_dari }}</p>
                    <p><strong>Email:</strong> {{ $item->pengunjung->email }}</p>
                    <p><strong>Subjek:</strong> {{ $item->subject }}</p>
                    <p><strong>Jam Kedatangan:</strong> {{ $item->waktu_temu }}</p>
                    <p><strong>Jam Kepulangan:</strong> {{ $item->waktu_kembali }}</p>
